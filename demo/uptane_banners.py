...
def print_banner_no_clearscreen(banner_array, show_for=False, color=False, color_bg=False,
    text=False, sound=False):
  """
  <Purpose>
    Clears current terminal window and prints passed banner array and
...
BANNER_BAD_HASH_ERROR = load_banner(demo.DEMO_DIR + "/ascii/bad_hash_error.txt")
